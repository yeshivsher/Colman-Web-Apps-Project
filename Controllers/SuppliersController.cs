...
namespace Colman_Final_Web_Project.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address")] Suppliers suppliers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address")] Suppliers suppliers)
        {
            if (id != suppliers.Id)
            {
                return NotFound();
